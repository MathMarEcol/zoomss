...
#### Basic Plots
* `zPlot_BiomassTimeSeries(dat)` - Plot biomass time series with optional species selection and proportional stacking
* `zPlot_SizeSpectra(dat)` - Plot overall species-resolved size spectra  
