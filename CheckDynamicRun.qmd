...
source("fZooMSS_Model.R") #source the static model code
source("fZooMSS_Model_Dynamic.R") #source the dynamic model code
...
out_static$model$model_runtime <- system.time(
  out_static <- fZooMSS_Model(input_params, Groups, SaveTimeSteps)
)
...
out_dynamic$model$model_runtime <- system.time(
  out_dynamic <- fZooMSS_Model_Dynamic(input_params, Groups, SaveTimeSteps, enviro_dynamic)
)
...
(fZooMSS_Plot_SizeSpectra(out_static) + fZooMSS_Plot_SizeSpectra(out_dynamic)) /
...
fZooMSS_Plot_AbundTimeSeries(out_static) / fZooMSS_Plot_AbundTimeSeries(out_dynamic) /
patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
...
fZooMSS_Plot_GrowthTimeSeries(out_static) / fZooMSS_Plot_GrowthTimeSeries(out_dynamic) /
  patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
...
out_dynamic2$model$model_runtime <- system.time(
  out_dynamic2 <- fZooMSS_Model_Dynamic(input_params, Groups, SaveTimeSteps, enviro_dynamic2)
)
...
```{r}
(fZooMSS_Plot_SizeSpectra(out_static) + fZooMSS_Plot_SizeSpectra(out_dynamic2)) /
  patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
...
fZooMSS_Plot_AbundTimeSeries(out_static) / fZooMSS_Plot_AbundTimeSeries(out_dynamic2) / patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
  ) &
...
out_dynamic3$model$model_runtime <- system.time(
  out_dynamic3 <- fZooMSS_Model_Dynamic(input_params, Groups, SaveTimeSteps, enviro_dynamic3)
)
...
(fZooMSS_Plot_SizeSpectra(out_dynamic) + fZooMSS_Plot_SizeSpectra(out_dynamic3)) /
  patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
...
fZooMSS_Plot_AbundTimeSeries(out_dynamic) / fZooMSS_Plot_AbundTimeSeries(out_dynamic3) /
  patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
...
fZooMSS_Plot_GrowthTimeSeries(out_dynamic) / fZooMSS_Plot_GrowthTimeSeries(out_dynamic3) /
  patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
...
out_dynamic4$model$model_runtime <- system.time(
  out_dynamic4 <- fZooMSS_Model_Dynamic(input_params, Groups, SaveTimeSteps, enviro_dynamic4)
)
...
(fZooMSS_Plot_SizeSpectra(out_dynamic) + fZooMSS_Plot_SizeSpectra(out_dynamic4)) /
  patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
...
fZooMSS_Plot_AbundTimeSeries(out_dynamic) / fZooMSS_Plot_AbundTimeSeries(out_dynamic4) /
  patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
...
fZooMSS_Plot_GrowthTimeSeries(out_dynamic) / fZooMSS_Plot_GrowthTimeSeries(out_dynamic4) /
  patchwork::guide_area() + patchwork::plot_layout(guides = "collect") & 
  theme(
    legend.position = "bottom",  # Move the legend to the bottom
    legend.box = "horizontal"    # Arrange legend items horizontally
